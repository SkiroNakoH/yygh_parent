...
public class Generator {
    ...
    public static void main(String[] args) {
        //创建一个代码生成器
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/yygh_hosp",
                "root", "123456")
                //全局配置(GlobalConfig)
                .globalConfig(builder -> {
                    builder.author("atguigu") // 设置作者
                            .fileOverride() // 覆盖已生成文件
                            .outputDir("C:\\Users\\SkiroNako\\Desktop\\yygh_parent\\service\\service_hosp\\src\\main\\java") // 指定输出目录，一般指定到java目录
